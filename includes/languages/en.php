...
$loc['alerts.desc'] = "You can send an alert to an online user or a mass alert to the whole hotel. PolarIS does not persist alerts.";
...
$loc['message.alert.sent'] = "Hotel alert sent to the online user.";
$loc['message.hotel.alert.sent'] = "Hotel alert broadcast to online users.";
$loc['error.polaris.unconfigured'] = "PolarIS CMS/RCON is not configured. Set POLARIS_CMS_URL/KEY/SECRET or POLARIS_RCON_HOST/PORT.";
$loc['error.polaris.failed'] = "PolarIS rejected the alert.";
$loc['error.user.missing'] = "That user id does not exist.";
$loc['error.user.offline'] = "That user is not online in the hotel. PolarIS alertuser only reaches a connected client.";
break;
case "housekeeping.alerts.display":
$loc['alerts.display.desc'] = "PolarIS has no alerts table. Hotel alerts reach online users only and are not stored on the website.";
$loc['alerts.no.persist'] = "There is no unread-alert queue. Send a hotel alert to an online user or broadcast to the hotel.";
$loc['mass'] = "Mass";
$loc['alert'] = "Alert";
$loc['userid'] = "User ID";
$loc['date'] = "Date";
...
$loc['alerts.create.single.desc'] = "Send a PolarIS alertuser command. The target must be online in the hotel.";
$loc['alerts.create.mass.desc'] = "Send a PolarIS hotelalert command. Only users currently online in the hotel will see it.";
$loc['userid'] = "User ID";
$loc['userid.desc'] = "The ID of the user you want to alert. Use the search box on the left if you don't know.";
$loc['alert'] = "Alert";
$loc['alert.desc'] = "The hotel alert text. PolarIS does not persist this.";
$loc['where'] = "Where";
$loc['where.desc'] = "Hotel alerts only. PolarIS has no website alerts table.";
$loc['site'] = "Site";
$loc['hotel'] = "Hotel";
$loc['hotel.only'] = "This is sent through PolarIS RCON/CMS (alertuser or hotelalert). Offline users are not queued.";
$loc['save'] = "Send";
