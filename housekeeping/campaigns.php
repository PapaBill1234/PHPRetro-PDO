...
$content .= 
'<div class="settings">
<form name="settings" action="'.PATH.'/housekeeping/campaigns?do=save" method="POST">'.Csrf::field();
...
<form name="settings" action="'.PATH.'/housekeeping/campaigns?do=remove" method="POST">'.Csrf::field().'
