...
try {
    ...
    $blocked = ['ajax_collectiblesPurchase.php', 'ajax_habboclub_gift.php', 'ajax_redeemvoucher.php', 'ajax_removeFeedItem.php', 'habboclub_habboclub_reminder_remove.php', 'habboclub_habboclub_subscribe.php', 'mod_add_report.php', 'myhabbo_avatarlist_friendsearchpaging.php', 'minimail_confirmReport.php', 'minimail_deleteMessage.php', 'minimail_emptyTrash.php', 'minimail_loadMessage.php', 'minimail_loadMessages.php', 'minimail_report.php', 'minimail_sendMessage.php', 'minimail_undeleteMessage.php'];
