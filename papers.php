...
?>
<div id="process-content"><div id="terms" class="box-content"><div class="tos-header"><b><?php echo $input->HoloText($title); ?></b></div><div class="tos-item"><?php echo $content; ?></div></div></div>
